...
export const Info = () => {
  return (
    <div className="relative h-[80dvh] px-1.5 pr-5 -mr-2.5 text-md overflow-y-auto">
      <div className="h-8 shrink-0 sticky top-0 bg-gradient-to-b from-neutral-800/100 to-neutral-800/0 z-10" />
      <h3 className="text-lg font-bold text-center pb-3 cursor-pointer italic">
        What is this?
      </h3>
      ...
      <h3 className="text-lg font-bold pt-8 text-center pb-3 cursor-pointer italic">
        How do I use it?
      </h3>
      ...
      <div className="flex flex-col gap-3 text-neutral-300">
        ...
        <p>
          To disable/enable cards, open the settings window by tapping the
          settings{" "}
          <TbSettings
            size={18}
        ...
        <p>
          To save this app on your phone or for offline use, tap the "Add to
          Homescreen" option in your mobile web browser. No extra permission is
          needed and the app functions identically without the visual clutter
          from your browser.
        </p>
      </div>
